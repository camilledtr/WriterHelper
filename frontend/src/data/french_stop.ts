export const stopwords: Array<string> = ['au', 'aux', 'avec', 'ce', 'ces', 'dans', 'de',
  'des', 'du', 'elle', 'en', 'et', 'eux', 'il', 'je', 'la', 'le', 'leur', 'lui', 'ma', 'mais',
  'me', 'même', 'mes', 'moi', 'mon', 'ne', 'nos', 'notre', 'nous', 'on', 'ou', 'par', 'pas',
  'pour', 'qu', 'que', 'qui', 'sa', 'se', 'ses', 'sur', 'ta', 'te', 'tes', 'toi', 'ton',
  'tu', 'un', 'une', 'vos', 'votre', 'vous', 'c', 'd', 'j', 'l', 'à', 'm', 'n', 's', 't',
  'y', 'étée', 'étées', 'étant', 'suis', 'es', 'êtes', 'sont', 'serai', 'seras', 'sera',
  ...
  'soit', 'soyons', 'soyez', 'soient', 'fusse', 'fusses', 'fussions', 'fussiez', 'fussent',
  'ayant', 'eu', 'eue', 'eues', 'eus', 'ai', 'avons', 'avez', 'ont', 'aurai', 'aurons', 'aurez',
